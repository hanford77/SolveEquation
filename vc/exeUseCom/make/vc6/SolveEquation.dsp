...
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\exeUseCom\bin\vc6-win32-RA
SOURCE="$(InputPath)"
...
# Begin Special Build Tool
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\exeUseCom\bin\vc6-win32-DA
SOURCE="$(InputPath)"
PostBuild_Cmds=del "$(TargetDir)\*.ilk"
# End Special Build Tool
...
# Begin Special Build Tool
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\exeUseCom\bin\vc6-win32-RU
SOURCE="$(InputPath)"
PostBuild_Cmds=del "$(TargetDir)\*.ilk"
# End Special Build Tool
...
# Begin Special Build Tool
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\exeUseCom\bin\vc6-win32-DU
SOURCE="$(InputPath)"
PostBuild_Cmds=del "$(TargetDir)\*.ilk"
# End Special Build Tool
...
SOURCE=..\..\src\comMFC.cpp
# End Source File
# Begin Source File

SOURCE=..\..\src\comMIDL.c
# SUBTRACT CPP /YX /Yc /Yu
# End Source File
# Begin Source File
