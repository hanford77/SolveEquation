...
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\SDK\bin\vc6-win32-RA
SOURCE="$(InputPath)"
...
# Begin Special Build Tool
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\SDK\bin\vc6-win32-DA
SOURCE="$(InputPath)"
PostBuild_Cmds=del "$(TargetDir)\*.ilk"
# End Special Build Tool
...
# Begin Special Build Tool
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\SDK\bin\vc6-win32-RU
SOURCE="$(InputPath)"
PostBuild_Cmds=del "$(TargetDir)\*.ilk"
# End Special Build Tool
...
# Begin Special Build Tool
TargetDir=\(yhf)\Exercise\math\一元多次方程\SolveEquation\vc\SDK\bin\vc6-win32-DU
SOURCE="$(InputPath)"
PostBuild_Cmds=del "$(TargetDir)\*.ilk"
# End Special Build Tool
